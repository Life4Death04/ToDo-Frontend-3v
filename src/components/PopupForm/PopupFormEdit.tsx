...
import { useUpdateTask } from "../../queries/tasksQuery";
 ...
 * @returns JSX.Element
 */
export default function PopupFormEdit({handleClose, initialValue}: PopupFormProps) {
            ...
            <section className="rounded-2xl bg-white px-3 py-2 xsm:w-70 sm:w-110 lg:w-150">
                ...
                <form onSubmit={(e) => {
                    ...
                    <Input
                        name="dueDate" 
                        type="date"
                        value={(updateFormData.dueDate ? new Date(updateFormData.dueDate).toISOString().split('T')[0] : '')}
                        label="Due Date"
